...
class IntentExtensionsAndroid32Test : BaseRobolectricTest() {
    ...
    fun get_compat_parcelable_extra_test() {
        getParcelableIntent(key, 22, "data_class_2")
            .getCompatParcelableExtra<ParcelableData>(key, Build.VERSION_CODES.S_V2)
            .apply {
    ...
    fun get_compat_parcelable_arraylist_extra_test() {
        getParcelableListIntent(key, 22, "data_class_2")
            .getCompatParcelableArrayListExtra<ParcelableData>(key, Build.VERSION_CODES.S_V2)
            .apply {
                Assert.assertNotNull(this)
                this!!
    ...
    fun get_compat_serializable_extra_test() {
        getSerializableIntent(key, 22, "data_class_2")
            .getCompatSerializableExtra<SerializableData>(key, Build.VERSION_CODES.S_V2)
            .apply {
                Assert.assertNotNull(this)
                this!!
                Assert.assertEquals(22, id)

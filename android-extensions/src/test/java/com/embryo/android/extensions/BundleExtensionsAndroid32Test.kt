...
class BundleExtensionsAndroid32Test : BaseRobolectricTest() {
    ...
    fun get_compat_parcelable_test() {
        getParcelableBundle(key, 21, "data_class")
            .getCompatParcelable<ParcelableData>(key, Build.VERSION_CODES.S_V2)
            .apply {
                assertNotNull(this)
                this!!
                assertEquals(21, id)
    ...
    fun get_compat_parcelable_arraylist_test() {
        getParcelableListBundle(key, 22, "data_class_2")
            .getCompatParcelableArrayList<ParcelableData>(key, Build.VERSION_CODES.S_V2)
            .apply {
                assertNotNull(this)
                this!!
    ...
    fun get_compat_serializable_test() {
        getSerializableBundle(key, 22, "data_class_2")
            .getCompatSerializable<SerializableData>(key, Build.VERSION_CODES.S_V2)
            .apply {
                assertNotNull(this)
                this!!
                assertEquals(22, id)
